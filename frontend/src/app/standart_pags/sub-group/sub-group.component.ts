...
import { SubGroupModalComponent } from 'src/app/modals/sub-group-modal/sub-group-modal.component';
import { EditSubGroupComponent } from 'src/app/edits_pags/edit-sub-group/edit-sub-group.component';
